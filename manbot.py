...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <table class="data-table">
                <thead>
                    <tr><th>Symbol</th><th>Price</th><th>24h Chg</th><th>24h High</th><th>24h Low</th><th>Actions</th></tr>
                </thead>
        ...
        function updateDashboard(data) {
            ...
            if (data.symbols && data.symbols.length > 0) {
                ...
                for (let sym of data.symbols) {
                    ...
                    let hasPosition = sym.has_position;
                    html += `<tr>
                        ...
                        <td class="action-buttons">
                            ...
                            ${hasPosition ? `<button onclick="manualAction('${sym.symbol}','close')" class="danger">Close</button>` : ''}
                        </td>
                    </tr>`;
                }
    ...
    def __init__(self):
        ...
        for symbol in self.symbols:
            ...
            if qty_env:
                ...
                self.symbol_quantities[symbol] = 0.01  # default fallback
