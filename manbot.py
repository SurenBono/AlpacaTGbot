...
# ALL AVAILABLE ALPACA CRYPTO SYMBOLS (hardcoded)
ALL_SYMBOLS = [
    "AAVE/USD", "ADA/USD", "ALGO/USD", "APE/USD", "ARB/USD",
    "ATOM/USD", "AVAX/USD", "BAT/USD", "BCH/USD", "BTC/USD",
    "CRV/USD", "DOGE/USD", "DOT/USD", "ETC/USD", "ETH/USD",
    "FIL/USD", "GRT/USD", "LINK/USD", "LTC/USD", "MATIC/USD",
    "MKR/USD", "NEAR/USD", "OP/USD", "SHIB/USD", "SOL/USD",
    "SUI/USD", "UNI/USD", "XLM/USD", "XTZ/USD"
]
    ...
    <div class="container">
                ...
                <div style="overflow-x: auto;">
                    <table class="data-table">
                        ...
                        <tbody id="positionsBody">
                            <tr><td colspan="10" style="text-align:center;">No active positions</td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div style="overflow-x: auto;">
                <table class="data-table">
                    <thead>
                        <tr><th>#</th><th>Symbol</th><th>Price</th><th>24h Chg</th><th>24h High</th><th>24h Low</th><th>Action</th></tr>
                    </thead>
                    <tbody id="symbolsBody">
                        <tr><td colspan="7" style="text-align:center;">Loading...</td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td></tr>
                    </tbody>
                </table>
            </div>
        </div>
    ...
    <script>
        ...
        function updateDashboard(data) {
            ...
            if (data.positions && data.positions.length > 0) {
                ...
                document.getElementById('positionsBody').innerHTML = '<tr><td colspan="10" style="text-align:center;">No active positions</td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td></tr>';
            }
...
class ManualSellBot:
    def __init__(self):
        ...
        # Load quantities from .env QUANTITY_XXX (optional, fallback to 0.01)
    ...
    def _log_configuration(self):
        ...
        logger.info(f"Symbols: {len(self.symbols)} symbols loaded")
    ...
    def run_strategy(self):
        ...
        self.add_log(f"📊 Monitoring {len(self.symbols)} symbols")
...
def main():
    ...
    try:
        ...
        print(f"   📊 {len(ALL_SYMBOLS)} symbols available")
        print("   🟢 Click BUY to enter positions")
        print("   🔴 Bot auto-sells at target profit")
        print("   📍 Close positions from Active Positions table")
        print("   🔢 Numbered lists for easy reference")
        print("")
