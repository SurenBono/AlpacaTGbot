...
<body>
    <div class="container">
            ...
            <div class="card">
                ...
                <div style="overflow-x: auto;">
                    <table class="data-table">
                        <thead>
                            <tr><th>Symbol</th><th>Qty</th><th>Entry</th><th>Current</th><th>Mkt Val</th><th>Net P&L</th><th>Net %</th><th>Target</th><th>Action</th></tr>
                        </thead>
                        <tbody id="positionsBody">
                            <tr><td colspan="9" style="text-align:center;">No active positions</td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
        ...
        <!-- All Symbols Card - Renamed -->
        <div class="card">
            <h3>📊 Manual Buy/Sell Symbols (price ↓)</h3>
            <div style="overflow-x: auto;">
                <table class="data-table">
                    <thead>
                        <tr><th>Symbol</th><th>Price</th><th>24h Chg</th><th>24h High</th><th>24h Low</th><th>Action</th></tr>
                    </thead>
                    <tbody id="symbolsBody">
                        <tr><td colspan="6" style="text-align:center;">Loading...</td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td><td style="display:none;"></td></tr>
                    </tbody>
                </table>
            </div>
        </div>
