...
<html>
<head>
    <title>MANUAL BOT - Auto Sell at Target Profit</title>
...
<body>
    <div class="container">
        ...
        <div class="subtitle">📍 Manual Buy Only | 🔄 Auto Sell at Target Net Profit (after spread + fees)</div>
        ...
        <!-- All Symbols Card - Sorted by Price -->
        <div class="card">
            <h3>📊 All Available Symbols - Manual Buy (sorted by price ↓)</h3>
            <table class="data-table">
                <thead>
        ...
        <div class="card">
            ...
            <div class="info-note">🟢 MANUAL BUY only | 🔴 AUTO SELL at target net profit</div>
        </div>
    </div>
    ...
    <script>
        ...
        function updateDashboard(data) {
            ...
            // All symbols - sorted by price already from backend
            ...
            for pos in positions:
                if pos.symbol == alpaca_symbol:
                    ...
                    if order and order.filled_avg_price:
                        ...
                        fill_price = current_price if 'current_price' in dir() else entry_price
                        net_pnl, gross_pnl, costs = self.calculate_net_pnl(entry_price, fill_price, qty)
...
def main():
    print("\n" + "="*50)
    print("🤖 MANUAL BOT - Auto Sell at Target Profit")
    print("="*50)
    print("  ACTION: Manual BUY only")
    print("  AUTO:   Sell when target net profit reached")
    ...
    try:
        ...
        print("   🔴 Auto-sell triggers at target net profit")
        print("   📊 Adjust target profit with slider in Live Controls")
        ...
        if response == 'y':
            ...
            print("📈 BUY manually via dashboard | SELL automatically at target profit")
            bot.run_strategy()
        else:
            print("Bot stopped.")
    except Exception as e:
